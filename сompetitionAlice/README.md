...
2. [Постановка задачи](#task-setting)
3. [Краткая информация о данных](#data-information)
4. [Этапы работы над проектом](#work-stages)
